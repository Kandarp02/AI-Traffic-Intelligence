...
## 🚨 Problem with Traditional Traffic Systems

Most urban traffic systems rely on **fixed-time signal control**, where traffic lights operate on pre-defined timers regardless of real-time conditions. This approach leads to:

- ⛔ **Inefficient Traffic Flow:** Green signals are wasted on empty roads while congested lanes remain blocked  
- 🚗 **Increased Congestion:** High-density lanes experience unnecessary delays, causing traffic buildup  
- 🚑 **No Emergency Handling:** Emergency vehicles like ambulances are stuck in traffic due to lack of dynamic prioritization  
- ⏳ **Poor Adaptability:** Fixed timers cannot respond to real-time variations such as peak hours, accidents, or uneven traffic distribution  

💡 This project addresses these limitations by replacing static timers with **AI-driven, real-time adaptive traffic control**.
